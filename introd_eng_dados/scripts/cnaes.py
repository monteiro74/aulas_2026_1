...
#            consulta SQL em uma tabela específica e exporta os dados obtidos
#            para um arquivo CSV. O objetivo é extrair registros e salvá-los
#            localmente para análises posteriores.
#
# Autor: Nome do aluno
# Data de Criação: 
# Hora de Criação: 
...
# tabela = input("Digite o nome da tabela (ex: cnaes): ")
