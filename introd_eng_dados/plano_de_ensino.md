...
|  2  | 04/mar | 3hs          | Processo KDD, Mineração x aprendizado de máquina, processo CRISP DM, dados não estruturados x estruturados, acesso a dados transacionais, data lake, etl, ferramentas para data lake, AWS S3, MinIO. [Slides de aula](https://docs.google.com/presentation/d/1v9RtnECfVh-NTGT7KP4wC6FrpScon8HrrvdiOqVwVOY/edit?usp=view). Na repositório da disciplinas estão os datasets e scripts python. [Anaconda](https://www.anaconda.com/download/success). |
